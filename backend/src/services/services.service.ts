...
export class ServicesService implements OnModuleInit {
    ...
    private async seedServices(): Promise<void> {
        ...
        // Agar mavjud xizmatlar soni 20 dan kam bo'lsa, yangilash kerak
        if (count > 0 && count < 60) {
            await this.serviceModel.deleteMany({});
            console.log('🔄 Old services cleared, reseeding with full list...');
        } else if (count >= 60) {
            return; // Already seeded with full list
        }

        const defaultServices = [
            // ==========================================
            // 🖨 POLIGRAFIYA XIZMATLARI (13 ta)
            // ==========================================
            {
            ...
            // ==========================================
            // 🏢 TASHQI REKLAMA XIZMATLARI (12 ta)
            // ==========================================
            {
            ...
            // ==========================================
            {
                ...
                category: ServiceCategory.ICHKI_REKLAMA,
                order: 1,
            },
            {
            ...
            // ==========================================
            {
                ...
                icon: 'globe',
                image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80',
                category: ServiceCategory.RAQAMLI_IT,
                order: 1,
            },
            {
            ...
            // ==========================================
            // 🎁 SOUVENIR & PROMO MAHSULOTLAR (6 ta)
            // ==========================================
            {
                ...
                category: ServiceCategory.SOUVENIR_PROMO,
                order: 1,
            },
            {
            ...
            // ==========================================
            {
                ...
                category: ServiceCategory.ISHLAB_CHIQARISH,
                order: 1,
            },
            {
